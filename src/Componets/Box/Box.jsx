    ...
    return (
        <div className="border-2 rounded-lg border-black h-175 w-375 ">
            <div className="flex flex-col text-white w-100">
                ...
                <a className="mt-50 ml-4 text-[22px] font-thin leading-none hover:text-fuchsia-800 hover:text-[27px] duration-500">Projects</a>
                ...
                <a href="/resume_pranetravyas.docx" download target='_blank'className="mt-5 ml-4 text-[22px] font-thin leading-none  hover:text-fuchsia-800 hover:text-[27px] duration-500">Resume</a>
            </div>
            <div className="flex text-amber-50 mt-62 mr-4 font-thin gap-4 justify-end items-end">
                <a href={"https://www.instagram.com/pranetra4/"} target="_blank">
