    ...
    return (
        <div className="border-2 rounded-lg border-black h-175 w-375 ">
            <div className="flex flex-col text-white w-100">
                ...
                <h1 className="mt-50 ml-4 text-[22px] font-thin leading-none hover:text-fuchsia-800 hover:text-[27px] duration-500">Projects</h1>
                <h1 className="mt-5 ml-4 text-[22px] font-thin leading-none  hover:text-fuchsia-800 hover:text-[27px] duration-500">Education</h1>
                <h1 className="mt-5 ml-4 text-[22px] font-thin leading-none  hover:text-fuchsia-800 hover:text-[27px] duration-500">Resume</h1>
            </div>
